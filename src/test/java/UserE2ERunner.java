...
public class UserE2ERunner {
    @Test
    public void testParallel(){
        Results results = com.intuit.karate.Runner.path("classpath:features/users/e2e/user-e2e.feature"
                )
    ...
    public void generateReport(String karateOuthPath){
        ...
        Configuration config = new Configuration( new File("target"), "Test create, update and delete user");

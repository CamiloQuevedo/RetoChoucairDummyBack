...
public class UserGetIdRunner {
    @Test
    public void testParallel(){
        Results results = Runner.path("classpath:features/users/get/user-get.feature"
                )
    ...
    public void generateReport(String karateOuthPath){
        ...
        Configuration config = new Configuration( new File("target"), "Test get");
